...
- Profiles show post, follower, and following counts with follower lists, and the people page lists the community. The moderator's account is the official one: it carries an "Official" badge, cannot be blocked or reported, and can pin posts to the top of the main feed (the welcome post, for example). "Bums of the month" in the right rail lists the five most liked posts of the last 30 days.
